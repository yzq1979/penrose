...
//   y: IFloatV<number>;
//   r: IFloatV<number>;
//   strokeWidth: IFloatV<number>;
//   style: IStrV<number>;
//   strokeStyle: IStrV<number>;
//   strokeColor: IColorV<number>;
//   color: IColorV<number>;
//   name: IStrV<number>;
// }
...
// const sampleColor = () => {
//   const [c0, c1] = [0.1, 0.9];
//   const rgb = [randFloat(c0, c1), randFloat(c0, c1), randFloat(c0, c1)];
//   return {
//     tag: "ColorV",
//     contents: {
//       tag: "RGBA",
...
//   w: IFloatV<number>;
//   h: IFloatV<number>;
//   fontSize: IStrV<number>;
//   polygon: IPolygonV<number>;
//   string: IStrV<number>;
//   rotation: IFloatV<number>;
//   style: IStrV<number>;
//   stroke: IStrV<number>;
//   color: IColorV<number>;
//   name: IStrV<number>;
